...
if (command == 'whmods3') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `tnnckl1553@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://youtube.com/channel/UClfUAjgtQ19vGnUbkQxTuAg`, `👤 Gada pawang nih senggol dong 😔`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://github.com/koncit/`, `🤖 Hanya bot biasa yang kadang suka eror ☺`]
  ], fakes)
